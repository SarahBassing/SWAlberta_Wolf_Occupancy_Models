################################################################################
  ...
  #  Covariates on detection: categorical H, M, L intensity of wolf harvest
...
################################################################################
  ...
  sink("SS_Wolf_basep_nwolf_FC_pHARV.txt")
  cat("
  model {
...
################################################################################
  ...
  params <- c("B0.psi", "B1.FC", "B1.pHvMed", "B1.pHvHi", "B0.p.rend", "B0.p.hunt", 
              "n.occ", "k.psi", "k.p.rnd", "k.p.hs", "n.packs", "mean.pack", 
              "n.wolves", "ann.occ", "mean.occ") # "psi"
  ...
  # Call JAGS 
  out <- jags(win.data, inits, params, "SS_Wolf_basep_nwolf_FC_pHARV.txt", n.chains=nc, 
              n.thin=nt, n.iter=ni, n.burnin=nb, jags.module = c("glm","dic"))
  
  jag.sum <- out$BUGSoutput$summary
  #write.table(x=jag.sum, file="./Output/SS_Wolf_basep_nwolf_FC_pHARV.txt", sep="\t")
  SS_Wolf_basep_nwolf_FC_pHARV_output <- out
  #save(SS_Wolf_basep_nwolf_FC_pHARV_output, file ="./Output/SS_Wolf_basep_nwolf_FC_pHARV_output.RData")
